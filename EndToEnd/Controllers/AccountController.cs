...
namespace EndToEnd.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        [AllowAnonymous]
        public ActionResult RegisterSmsUser()
        {
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterSmsUser(RegisterSmsUserViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                   ...
                   db.SmsUsers.Add(smsUser);
                    ...
                    await this.UserManager.AddToRoleAsync(user.Id, "SmsUser");

                    ViewBag.Message = "Registration was Succesful... Please Login to Continue ";
                    return RedirectToAction("Login", new {returnUrl = ViewBag.Message});
                }

            }
            ViewBag.Message = "Registration was NOT successful, Try again";
            return View(model);
        }
        ...
        private void CreateAdminIfNeeded()
        {
            ...
            if (objAdminUser == null)
            {
                ...
                // Create Admin user
                var objNewAdminUser = new ApplicationUser { UserName = AdminUserName, Email = AdminUserName , FirstName = "Admin"};
